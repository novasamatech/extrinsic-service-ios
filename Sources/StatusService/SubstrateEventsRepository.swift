...
public final class SubstrateEventsRepository: SubstrateEventsRepositoryProtocol {
    public init() { }
    public func getInherentEvents(from eventRecords: [EventRecord]) -> SubstrateInherentsEvents {
        .init(
    ...
    public func getExtrinsicsEvents(from block: Block, eventRecords: [EventRecord]) -> [SubstrateExtrinsicEvents] {
