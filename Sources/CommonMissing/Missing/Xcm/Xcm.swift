...
public enum Xcm {
    ...
    public enum Version: UInt8, Comparable, CaseIterable {
        case V0
        case V1
        case V2
        case V3
        ...
        public static func < (lhs: Xcm.Version, rhs: Xcm.Version) -> Bool {
    ...
    public enum Outcome<W: Decodable, E: Decodable>: Decodable {
        public struct Complete: Decodable {
            let used: W
        }

        public struct Incomplete: Decodable {
            let used: W
            let error: E
        }
