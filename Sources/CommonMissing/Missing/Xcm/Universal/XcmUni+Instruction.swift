...
extension XcmUni {
    public struct DepositAssetValue: Equatable {
    ...
    public struct BuyExecutionValue: Equatable {
        let fees: Asset
        let weightLimit: WeightLimit
    }

    public struct DepositReserveAssetValue: Equatable {
        let assets: AssetFilter
    ...
    public struct InitiateReserveWithdrawValue: Equatable {
        let assets: AssetFilter
        let reserve: RelativeLocation
        let xcm: Instructions
    }

    public struct InitiateTeleportValue: Equatable {
        let assets: AssetFilter
        let dest: RelativeLocation
        let xcm: Instructions
    }
