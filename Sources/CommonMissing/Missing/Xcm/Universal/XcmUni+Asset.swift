...
extension XcmUni {
    public struct AssetId: Equatable {
        let location: RelativeLocation
    }

    public enum WildAsset: Equatable {
        /**
         * Filter to use all assets from the holding register
         *
         * !!! Important !!!
         * Weight of this inpublic struction is bounded by maximum number of assets usable per inpublic struction,
         * which can be 100 in some runtimes.
         * This might result in sever overestimation of inpublic struction weight and thus, the fee.
         *
    ...
    public typealias AssetInstance = RawValue

    public enum Fungibility: Equatable {
    ...
    public struct Asset: Equatable {
        ...
        public init(location: RelativeLocation, amount: BigUInt) {
        ...
        public init(assetId: AssetId, amount: BigUInt) {
...
extension XcmUni.AssetId {
    public init(fromPreV4 decoder: any Decoder, configuration: Xcm.Version) throws {
    ...
    public init(fromPostV4 decoder: any Decoder, configuration: Xcm.Version) throws {
...
extension XcmUni.AssetFilter: XcmUniCodable {
    ...
    public func encode(to encoder: Encoder, configuration: Xcm.Version) throws {
        var container = encoder.unkeyedContainer()
