...
public final class DummySigner: SigningWrapperProtocol {
    let type: DummySigningType

    public init(cryptoType: MultiassetCryptoType, seed: Data = Data(repeating: 1, count: 32)) throws {
        switch cryptoType {
        case .sr25519:
    ...
    public func sign(_ originalData: Data, context _: ExtrinsicSigningContext) throws -> IRSignatureProtocol {
        switch type {
