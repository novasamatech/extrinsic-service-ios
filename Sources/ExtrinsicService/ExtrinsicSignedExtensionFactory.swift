...
/**
 *     Signed public extension setup consists of the 2 parts:
 *      - provide signed public extension class that contains parameters for the extrinsic's signed extra
 *      - provide coders to encode/decode signed public extension's parameters part of signed extra
 */
